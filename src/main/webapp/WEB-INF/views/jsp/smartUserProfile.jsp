                ...
                <div class="row mb-4">
                    <div class="col-12 col-xl-6 center-block">
                        <div class="card redial-border-light redial-shadow mb-4">
                            <div class="card-body">
                                <form:form method="POST" name="smartProfile" modelAttribute="smartUser" class="form-signin">
                                    <img src="${contextPath}/resources/s2/dist/images/logo-finsmart.png" height="60"  alt="" > Access</img>
                                    <%
                                    ...
                                    <div class="col-md-6 mb-3 text-right">
                                        <div class='btn-group mb-2'>
                                            <a href="/finsmart" class="btn-primary btn btn-block rounded">Close</a>
                                        </div>
                                    </div>
                                </form:form>
                            </div>
...
<script>
    window.onload = function () {
        toastr.error('Connection failed, please update your Finsmart credentials');
    };
</script>
<%}%>
<script>
    function connectionTest(){
        ...
        $.ajax({
            url: 'smartTestConnection',
            type: 'GET',
            data : $('form[name=smartProfile]').serialize(),
