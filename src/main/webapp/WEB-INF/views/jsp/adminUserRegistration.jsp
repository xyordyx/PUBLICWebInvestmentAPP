...
<head>
    ...
    <title>GMP SYSTEM - Admin User Registration</title>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 mb-4 col-xl-8 center-block">
                        <div class="card redial-border-light redial-shadow mb-4">
                            <div class="card-body">
                                <h5 class="pl-3 redial-relative">USER REGISTRATION</h5>
                                <form:form method="POST" name="userRegistration" modelAttribute="user" class="form-signin">
                                    ...
                                    <div class='btn-group mb-2'>
                                        <button type="submit" class="btn-primary btn btn-block rounded">Create an Account</button>
                                    </div>
                                    <div class='btn-group mb-2'>
