...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Privilege investmentAPPPrivilege = createPrivilegeIfNotFound("investmentAPP_PRIVILEGE");
        ...
        final List<Privilege> adminPrivileges = new ArrayList<>(Arrays.asList(userPrivilege, readPrivilege, writePrivilege,
                passwordPrivilege,investmentAPPPrivilege, adminPrivilege, facturedoPrivilege));
        final List<Privilege> userPrivileges = new ArrayList<>(Arrays.asList(userPrivilege,readPrivilege, passwordPrivilege));
        final List<Privilege> investmentAPPPrivileges = new ArrayList<>(Arrays.asList(userPrivilege,
                readPrivilege, passwordPrivilege,investmentAPPPrivilege));
        ...
        final Role investmentAPPRole = createRoleIfNotFound("ROLE_investmentAPP", investmentAPPPrivileges);
        ...
        // == create initial investmentAPPuser
        //createUserIfNotFound("fin", "Fin", "Smart", "root", new ArrayList<>(Arrays.asList(investmentAPPRole)));
