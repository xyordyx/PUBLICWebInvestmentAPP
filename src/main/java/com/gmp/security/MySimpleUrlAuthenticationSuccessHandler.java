...
import com.gmp.service.DeviceService;
    ...
    protected String determineTargetUrl(final Authentication authentication) {
        ...
        for (final GrantedAuthority grantedAuthority : authorities) {
            ...
            if (grantedAuthority.getAuthority().equals("ADMIN_PRIVILEGE")) {
                ...
                //isUser = false;
                break;
            } else if(grantedAuthority.getAuthority().equals("investmentAPP_PRIVILEGE") ||
                    grantedAuthority.getAuthority().equals("FACTUREDO_PRIVILEGE")){
                isSmartUser = true;
            }
        }
        /*if (isUser) {
            ...
            return "/index?user="+username;} else*/
        if (isAdmin) {
            return "/adminHome";
        } else if(isSmartUser){
            return "/landing";
