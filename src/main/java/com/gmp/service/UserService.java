...
public class UserService implements IUserService {
    ...
    public void updateUserAdmin(User user, boolean change) {
        List<String> currencyList = investmentAPPUtil.parseString(user.getTempRol()).stream()
                .distinct()
    ...
    public User registerNewUserAccount(final User user) {
        ...
        List<String> currencyList = investmentAPPUtil.parseString(user.getTempRol());
    ...
    @Override
    public void saveinvestmentAPPProfile(final SmartUser smartUser) {
    ...
    @Override
    public SmartUser getinvestmentAPPProfile(User user) {
