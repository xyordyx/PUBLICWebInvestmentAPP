...
public class AppController {
    ...
    public String adminUserRegistration(Model model) {
        ...
        roleMap.put("ROLE_FINSMART", "FINSMART");
    ...
    public String adminUserRegistration(@ModelAttribute("user") User user, final HttpServletRequest request) {
        ...
        eventPublisher.publishEvent(new OnRegistrationCompleteEvent(registered, request.getLocale(), FinSmartUtil.getAppUrl(request)));
